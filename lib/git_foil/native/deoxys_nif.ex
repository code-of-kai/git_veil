defmodule GitFoil.Native.DeoxysNif do
  @moduledoc """
  ...
  **Security:**
  ...
  use Rustler, otp_app: :git_foil, crate: :deoxys_nif
  ...
  ## Example
      ...
      iex> {:ok, {ct, tag}} = GitFoil.Native.DeoxysNif.encrypt(key, nonce, "secret", "metadata")
      iex> byte_size(tag)
      16
  """
  ...
  ## Example
      ...
      iex> nonce = :crypto.strong_rand_bytes(15)
      iex> {:ok, {ct, tag}} = GitFoil.Native.DeoxysNif.encrypt(key, nonce, "secret", "metadata")
      iex> {:ok, plaintext} = GitFoil.Native.DeoxysNif.decrypt(key, nonce, ct, tag, "metadata")
      iex> plaintext
      "secret"
  """

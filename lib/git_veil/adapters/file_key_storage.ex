defmodule GitVeil.Adapters.FileKeyStorage do
  @moduledoc """
  File-based key storage adapter for production use.

  Stores the master keypair in `.git/git_veil/master.key` using Erlang's
  ...
  **Security:**
  ...
  @doc """
  Checks if GitVeil has been initialized (keypair exists).
  """
  def initialized? do

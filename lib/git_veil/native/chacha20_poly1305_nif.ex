defmodule GitVeil.Native.ChaCha20Poly1305Nif do
  @moduledoc """
  ...
  **Security:**
  ...
  use Rustler, otp_app: :git_veil, crate: :chacha20poly1305_nif
  ...
  ## Example
      ...
      iex> {:ok, {ct, tag}} = GitVeil.Native.ChaCha20Poly1305Nif.encrypt(key, nonce, "secret", "metadata")
      iex> byte_size(tag)
      16
  """
  ...
  ## Example
      ...
      iex> nonce = :crypto.strong_rand_bytes(12)
      iex> {:ok, {ct, tag}} = GitVeil.Native.ChaCha20Poly1305Nif.encrypt(key, nonce, "secret", "metadata")
      iex> {:ok, plaintext} = GitVeil.Native.ChaCha20Poly1305Nif.decrypt(key, nonce, ct, tag, "metadata")
      iex> plaintext
      "secret"
  """

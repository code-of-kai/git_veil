defmodule GitFoil.Core.TripleCipherTest do
  use ExUnit.Case, async: true

  alias GitFoil.Core.{TripleCipher, Types}
  ...
  describe "triple-layer quantum-resistant encryption" do
    setup do
      # Generate six independent keys (DerivedKeys now requires all 6)
      derived_keys = %DerivedKeys{
        layer1_key: :crypto.strong_rand_bytes(32),  # AES-256-GCM
        layer2_key: :crypto.strong_rand_bytes(32),  # AEGIS-256
        layer3_key: :crypto.strong_rand_bytes(32),  # Schwaemm256-256
        layer4_key: :crypto.strong_rand_bytes(32),  # Deoxys-II-256
        layer5_key: :crypto.strong_rand_bytes(16),  # Ascon-128a
        layer6_key: :crypto.strong_rand_bytes(32)   # ChaCha20-Poly1305
      }
    ...
    test "wrong key causes authentication failure", %{derived_keys: keys} do
      ...
      wrong_keys = %DerivedKeys{
        ...
        layer2_key: :crypto.strong_rand_bytes(32),  # Wrong AEGIS key
        layer3_key: :crypto.strong_rand_bytes(32),  # Wrong Schwaemm key
        layer4_key: :crypto.strong_rand_bytes(32),  # Wrong Deoxys key
        layer5_key: :crypto.strong_rand_bytes(16),  # Wrong Ascon key
        layer6_key: :crypto.strong_rand_bytes(32)   # Wrong ChaCha20 key
      }

defmodule GitVeil.Adapters.FileKeyStorageTest do
  use ExUnit.Case, async: false

  alias GitVeil.Adapters.FileKeyStorage
  alias GitVeil.Core.Types.{Keypair, EncryptionKey}

  @test_key_dir ".git/git_veil"
  @test_key_file ".git/git_veil/master.key"
  ...
  describe "store_keypair/1 and retrieve_keypair/0" do
    ...
    test "creates .git/git_veil directory if it doesn't exist" do

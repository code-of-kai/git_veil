defmodule GitVeil.Commands.InitDecisionForksTest do
  @moduledoc """
  Comprehensive decision fork tests for git-veil init command.
  ...
  alias GitVeil.TestMocks.{MockGit, MockTerminal}
    ...
    test "Path G1: User enters 'Y' to encrypt matching files" do
      MockGit.configure(
        ...
        check_attr_batch: fn _attr, _files ->
          {:ok, [{"test.env", "filter: gitveil"}, {"secret.key", "filter: gitveil"}]}
        end,

defmodule GitVeil.Commands.NonInteractiveDecisionForksTest do
  @moduledoc """
  Comprehensive decision fork tests for non-interactive git-veil commands.
  ...
  alias GitVeil.Commands.{Commit, Pattern}
  alias GitVeil.CLI
  ...
  describe "Fork 8: Remove-Pattern Command" do
    ...
    test "Path P1: Existing pattern - removes successfully" do
      ...
      content = File.read!(".gitattributes")
      refute content =~ "*.env filter=gitveil"
    end
  ...
  describe "Fork 13: Version Command" do
    test "Path U1: Shows version number" do
      ...
      assert {:ok, msg} = result
      assert msg =~ "version" or msg =~ "GitVeil"
    end
  end
  ...
  describe "Fork 14: Help Command" do
    test "Path V1: 'git-veil help' - shows general help" do
      result = CLI.run(["help"])
    ...
    test "Path V2: 'git-veil help patterns' - shows pattern syntax help" do
    ...
    test "Path V3: 'git-veil --help' - shows general help" do
      result = CLI.run(["--help"])
    ...
    test "Path V4: 'git-veil -h' - shows general help" do
      result = CLI.run(["-h"])
